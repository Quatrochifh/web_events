...
String priceFormat(double price) {
  final format = new NumberFormat("#,##0.00", "pt_BR");
...
/*
  .. Formatos 
*/
String dateTimeFormat( String value, { String? dateFormat } ){

  final f = new DateFormat( dateFormat ?? 'dd/MM/y HH:mm:ss' ); 
...
String dateFormat( String value ){ 
  final f = new DateFormat('dd/MM/y');
...
String dateDayAndMonthName( String date ){

  //Lembre-se... A data deve ser (YYYY-MM-DD)
